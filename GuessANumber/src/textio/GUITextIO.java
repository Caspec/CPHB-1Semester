...
/**
public class GUITextIO extends javax.swing.JFrame 
 *
 * @author kasper
 */
public class GUITextIO extends javax.swing.JFrame implements ISimpleTextIO
{
    ...
    static
    {
        ...
        {
            java.util.logging.Logger.getLogger(GUITextIO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
