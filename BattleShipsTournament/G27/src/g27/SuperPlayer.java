 ...
 * @author HeroinGod
 */
public class SuperPlayer implements BattleshipsPlayer
{
    ...
    private int[][] shot;
    private int[][] fire = new int[sizeX][sizeY]; 
    boolean hit;
    Fleet enemyShips;
...
//            boolean vertical = true;
        ...
        // Shoots from 0,0 and straight up... systematic shooter reverse
...
//                else
//                {
//                    while (fire[x][y] != 0) // kør til at der bliver fundet et sted hvor der ikke er skudt før.
//                    {
//                        x = rnd.nextInt(sizeX);
//                        y = rnd.nextInt(sizeY);
//                    }
...
//        }
//    
//        if(!hit) // Hvis skud ikke ramte (skyd ramdom igen, endtil der rammes)
//        {
//            
//            if (shot[x][y] == 1) // Hvis der ikke er skudt her før.
//            {
//                shot[x][y] = 1;
//                return new Position(x, y);
//                
...
//            else 
//            {
//                while (shot[x][y] == 1) // kør til at der bliver fundet et sted hvor der ikke er skudt før.
//                {
//                    x = rnd.nextInt(sizeX);
//                    y = rnd.nextInt(sizeY);
//                }
